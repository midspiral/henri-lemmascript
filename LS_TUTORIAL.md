...
The headline: **70 Dafny verification conditions, 0 errors**, across four
...
append side's invariant rather than re-deriving it.
...
npm run verify     # ../LemmaScript/tools/check.sh dafny — regenerates, enforces
                   # additions-only, runs Dafny over all four: 70 VCs, 0 errors
...
- [`README_LemmaScript.md`](README_LemmaScript.md) — the full property/lemma
  reference (what each of the 70 VCs proves).
